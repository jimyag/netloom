...
func TestPrintReconcileResultIncludesPolicyMapUsageSummary(t *testing.T) {
	...
	for _, expected := range []string{
		...
		"provider_network_status=physnet-a:ready:1/1:0:none:tenants=1:subnets=1:endpoints=2:load_balancers=1:prod=ok:1/2:2/3:1/4,physnet-b:degraded:0/1:1:type-mismatch",
