...
func writeControllerMetrics(w metricWriter, snapshot controllerMetricsSnapshot, totals controllerMetricsTotals) {
	...
	writeMetricType(w, "netloom_controller_ovn_cleanup_stale_bfds", "gauge")
	fmt.Fprintf(w, "netloom_controller_ovn_cleanup_stale_bfds%s %d\n", baseLabels, snapshot.OVNCleanup.StaleBFDs)
