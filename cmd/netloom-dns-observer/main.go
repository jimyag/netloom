...
func dnsSocketFilterProgramSpec() *ebpf.ProgramSpec {
	...
	return &ebpf.ProgramSpec{
		...
		Instructions: asm.Instructions{
			...
			asm.JEq.Imm(asm.R0, 0x0800, "ipv4_l3_14"),
			asm.JEq.Imm(asm.R0, 0x86dd, "ipv6_l3_14"),
			asm.JEq.Imm(asm.R0, 0x8100, "vlan_l3_18"),
			asm.JEq.Imm(asm.R0, 0x88a8, "vlan_l3_18"),
			asm.Ja.Label("drop"),

			asm.LoadAbs(16, asm.Half).WithSymbol("vlan_l3_18"),
			asm.JEq.Imm(asm.R0, 0x0800, "ipv4_l3_18"),
			asm.JEq.Imm(asm.R0, 0x86dd, "ipv6_l3_18"),
			asm.JEq.Imm(asm.R0, 0x8100, "vlan_l3_22"),
			asm.JEq.Imm(asm.R0, 0x88a8, "vlan_l3_22"),
			asm.Ja.Label("drop"),

			asm.LoadAbs(20, asm.Half).WithSymbol("vlan_l3_22"),
			asm.JEq.Imm(asm.R0, 0x0800, "ipv4_l3_22"),
			asm.JEq.Imm(asm.R0, 0x86dd, "ipv6_l3_22"),
			asm.Ja.Label("drop"),

			asm.LoadAbs(14, asm.Byte).WithSymbol("ipv4_l3_14"),
			...
			asm.LoadAbs(18, asm.Byte).WithSymbol("ipv4_l3_18"),
			asm.JNE.Imm(asm.R0, 0x45, "drop"),
			asm.LoadAbs(27, asm.Byte),
			asm.JNE.Imm(asm.R0, unix.IPPROTO_UDP, "drop"),
			asm.LoadAbs(38, asm.Half),
			asm.JNE.Imm(asm.R0, 53, "drop"),
			asm.LoadAbs(48, asm.Byte),
			asm.JSet.Imm(asm.R0, 0x80, "pass"),
			asm.Ja.Label("drop"),

			asm.LoadAbs(22, asm.Byte).WithSymbol("ipv4_l3_22"),
			asm.JNE.Imm(asm.R0, 0x45, "drop"),
			asm.LoadAbs(31, asm.Byte),
			asm.JNE.Imm(asm.R0, unix.IPPROTO_UDP, "drop"),
			asm.LoadAbs(42, asm.Half),
			asm.JNE.Imm(asm.R0, 53, "drop"),
			asm.LoadAbs(52, asm.Byte),
			asm.JSet.Imm(asm.R0, 0x80, "pass"),
			asm.Ja.Label("drop"),

			asm.LoadAbs(20, asm.Byte).WithSymbol("ipv6_l3_14"),
			asm.JNE.Imm(asm.R0, unix.IPPROTO_UDP, "drop"),
			...
			asm.LoadAbs(24, asm.Byte).WithSymbol("ipv6_l3_18"),
			asm.JNE.Imm(asm.R0, unix.IPPROTO_UDP, "drop"),
			asm.LoadAbs(58, asm.Half),
			asm.JNE.Imm(asm.R0, 53, "drop"),
			asm.LoadAbs(68, asm.Byte),
			asm.JSet.Imm(asm.R0, 0x80, "pass"),
			asm.Ja.Label("drop"),

			asm.LoadAbs(28, asm.Byte).WithSymbol("ipv6_l3_22"),
			asm.JNE.Imm(asm.R0, unix.IPPROTO_UDP, "drop"),
			asm.LoadAbs(62, asm.Half),
			asm.JNE.Imm(asm.R0, 53, "drop"),
			asm.LoadAbs(72, asm.Byte),
			asm.JSet.Imm(asm.R0, 0x80, "pass"),
