...
func TestReconcileNodeAggregatesPolicyMapPressureSummary(t *testing.T) {
	...
	wantHotspots := []dataplane.PolicyMapPressureHotspot{
		{EndpointID: model.EndpointKey("prod", "pod-a"), Entries: 12, Capacity: 16, AvailableEntries: 4, PressurePercent: 75, Severity: dataplane.PolicyMapPressureNormal},
		{EndpointID: model.EndpointKey("prod", "pod-b"), Entries: 8, Capacity: 16, AvailableEntries: 8, PressurePercent: 50, Severity: dataplane.PolicyMapPressureNormal},
	}
