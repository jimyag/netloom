...
API range, with priority 0 retained as the desired-state compatibility default.
This keeps platform guardrails deterministic without moving security-group
enforcement back into OVN ACLs.
