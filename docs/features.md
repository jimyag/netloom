...
| Policy Route | 已实现 | OVN `Logical_Router_Policy` 和 Linux RPDB projection；审计/修复未声明的 stale `bfd_sessions` | `TestDockerLinuxPolicyRoutingProgramsAndCleansRuntimeState`、`TestPlanProgramsLinuxPolicyRoutes`、`TestLibOVSDBTopologyWriterClearsPolicyRouteStaleBFDSessions` |
