...
| Metrics | 已实现 | controller/agent `/metrics`, including per-endpoint policy-map revision, usage, pressure, severity, drift, last-event success/remediation, and `last_seen` timestamp gauges | command tests |
