...
- deeper clustered OVS/OVN controller connectivity analysis beyond local Bridge.Controller `is_connected` status, such as cluster-wide controller quorum and per-chassis path attribution
