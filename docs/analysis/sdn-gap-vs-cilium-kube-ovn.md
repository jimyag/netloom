...
- deeper clustered OVS/OVN controller connectivity analysis beyond local Bridge.Controller `is_connected` and OVSDB `Controller.status` target/state/role/error detail, such as cluster-wide controller quorum and per-chassis path attribution
